...
var client = new Twitter({
 ...
 // ------------------------------------STREAM
  ...
  stream.on('data', function(event) {
    ...
    var formatedDate = (d.getMonth() + 1).toString() + '-' + (d.getDate()).toString() + 'T' + (d.getHours()).toString() + ':' + (d.getMinutes()).toString() + ':' + (d.getSeconds()).toString();
   ...
   arrIds[formatedDate] = event.id_str; //Se agrega el horario y se asocia a un ID de tweet
   ...
   //   -----------------------------------RENOVAR ONTIME 
     var OT = ontime({
      ...
      var dOT = new Date();
      dOT.setDate(dOT.getUTCDate());

      console.log('Horario de ejecución (UTC): ' + dOT)
